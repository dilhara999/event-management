                        ...
                        <div class="card  login-card" style="border-radius: 1rem;">
                            <div class="row g-0">
                                <div class="col-md-6 col-lg-5 d-none d-md-block">
                                    ...
                                    {{-- image --}}
                                    <img src="assets/image/register/bgimg.jpg" alt="login form" class="img-fluid"
                                    ...
                                    {{-- database connection --}}
                                        ...
                                        <form action="{{ url('signIn') }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group pt-3 mb-5 text-center">
                                                ...
                                                <h6 class="txt1">Kindly fill in this form to Register</h6>
                                            </div>
                                        ...
                                        <p class="pt-4  text-xl-center">Do you have an account?
                                            <a href="{{ url('regStart') }}" class="loginlinkl">Login</a>
                                        </p>
